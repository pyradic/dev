...
class MenusModuleServiceProvider extends AddonServiceProvider
{
    ...
    protected $routes = [
        ...
        'admin/menus/links/{menu?}'            => [ 'as' => 'pyro.module.menus::links', 'uses' => 'Pyro\MenusModule\Http\Controller\Admin\AjaxLinksController@index' ],
        ...
        'admin/menus/links/{menu}/form/{type}' => [ 'as' => 'pyro.module.menus::links.form', 'uses' => 'Pyro\MenusModule\Http\Controller\Admin\AjaxLinksController@getForm' ],
        ...
        'admin/menus/links/choose/{menu}'      => [ 'as' => 'pyro.module.menus::links.choose', 'uses' => 'Pyro\MenusModule\Http\Controller\Admin\LinksController@choose' ],
