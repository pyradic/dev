...
// EXTERNAL MODULE: external ["pyro","pyro__platform"]
var external_pyro_pyro_platform_ = __webpack_require__("@pyro/platform");

// CONCATENATED MODULE: ./addons/shared/pyro/admin-theme/lib/AdminThemeServiceProvider.ts
var AdminThemeServiceProvider_AdminThemeServiceProvider=function(_super){Object(tslib_es6["d" /* __extends */])(AdminThemeServiceProvider,_super);function AdminThemeServiceProvider(){return _super!==null&&_super.apply(this,arguments)||this;}AdminThemeServiceProvider.prototype.register=function(){};return AdminThemeServiceProvider;}(external_pyro_pyro_platform_["ServiceProvider"]);
// CONCATENATED MODULE: ./addons/shared/pyro/admin-theme/lib/AdminThemeVuePlugin.ts
var AdminThemeVuePlugin_AdminThemeVuePlugin=function(){function AdminThemeVuePlugin(){}AdminThemeVuePlugin.install=function(_Vue,opts){if(opts===void 0){opts={};}if(this.__installed){return;}this.__installed=true;Object(external_pyro_pyro_platform_["prefixAndRegisterComponents"])(_Vue,{});};AdminThemeVuePlugin.__installed=false;return AdminThemeVuePlugin;}();
...
(function() { module.exports = window["pyro"]["pyro__platform"]; }());

/***/ })

/******/ });
//# sourceMappingURL=pyro__admin_theme.js.map