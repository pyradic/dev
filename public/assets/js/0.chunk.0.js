...
/***/ "./packages/pyradic/platform/lib/utils/tree-node.ts":
/*!**********************************************************!*\
  !*** ./packages/pyradic/platform/lib/utils/tree-node.ts ***!
  \**********************************************************/
/*! exports provided: NodeWalker, NodeArray, BaseNode, Node, RootNode, ValuedNode */
...
/* harmony import */ var _classes_Collection__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../classes/Collection */ "./packages/pyradic/platform/lib/classes/Collection.ts");
...
function () {
  ...
  NodeWalker.prototype.walk = function (node, visitor) {
    var _this = this;
    ...
    node.getChildren().forEach(function (childNode) {
      return _this.walk(childNode, visitor);
    });
...
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_12__["__extends"])(NodeArray, _super);

  function NodeArray() {
    return _super !== null && _super.apply(this, arguments) || this;
  }

  NodeArray.prototype.item = function (key) {
    return this[key];
  };

  NodeArray.prototype.hasItem = function (key) {
    return this[key] !== undefined;
  };

  NodeArray.prototype.depth = function (depth) {
    return this.filter(function (item) {
      return item.getDepth() === depth;
    });
  };

  NodeArray.prototype.root = function () {
    return this.filter(function (item) {
      return item.isRoot;
    });
  };

  NodeArray.prototype.without = function (item) {
    return this.filter(function (i) {
      return !item.includes(i);
    });
  };

  NodeArray.prototype.only = function (item) {
    return this.filter(function (i) {
      return item.includes(i);
    });
  };
  ...
  return NodeArray;
}(_classes_Collection__WEBPACK_IMPORTED_MODULE_13__["Collection"]);
...
function () {
  ...
  BaseNode.prototype.setIndex = function (index) {
    this._index = index;
    return this;
  };

  BaseNode.prototype.setCollectionClass = function (collectionClass) {
    this.collectionClass = collectionClass;
    return this;
  };

  BaseNode.prototype.newCollection = function (items) {
    var _a;
    ...
    return new ((_a = this.collectionClass).bind.apply(_a, Object(tslib__WEBPACK_IMPORTED_MODULE_12__["__spreadArrays"])([void 0], items)))();
  };

  BaseNode.prototype.hasChild = function (child) {
  ...
  BaseNode.prototype.removeChild = function (childToRemove) {
    var _this = this;
    ...
    var index = this.children.findIndex(function (node) {
  ...
  BaseNode.prototype.getAllDescendants = function () {
    var descendants = [];

    for (var _i = 0, _a = this.getChildren(); _i < _a.length; _i++) {
      var child = _a[_i];
      descendants.push(child);
      descendants.push.apply(descendants, child.getAllDescendants());
    }

    return this.newCollection(descendants);
  };

  BaseNode.prototype.removeAllChildren = function () {
    this.children = [];
    return this;
  };
  ...
  BaseNode.prototype.getAncestors = function () {
    var parents = [];
    var parent;
    var node = this;
  ...
  BaseNode.prototype.removeParentFromChildren = function () {
    for (var _i = 0, _a = this.children; _i < _a.length; _i++) {
      var child = _a[_i];
  ...
  BaseNode.prototype.isChild = function () {
  ...
  BaseNode.prototype.isRoot = function (matchType) {
    if (matchType === void 0) {
      matchType = false;
    }
  ...
  BaseNode.prototype.hasMatchingParentType = function () {
  ...
  BaseNode.prototype.hasParent = function () {
    return this.parent !== undefined;
  };

  BaseNode.prototype.hasChildren = function () {
    return Array.isArray(this.children) && this.children.length > 0;
  };

  BaseNode.prototype.getAncestorsAndSelf = function () {
    return this.getAncestors().concat([this]);
  };
  ...
  BaseNode.prototype.getHeight = function () {
    return this.getAncestors().length;
  };

  BaseNode.prototype.getLevel = function () {
    return this.getAncestors().length;
  };

  BaseNode.prototype.getNeighbors = function () {
    return this.getParent().getChildren().without([this]);
  };

  BaseNode.prototype.getNeighborsAndSelf = function () {
  ...
  BaseNode.prototype.isFirst = function () {
    return this.hasPrevious() === false;
  };

  BaseNode.prototype.isLast = function () {
    return this.hasNext() === false;
  };

  BaseNode.prototype.hasAncestor = function () {
    return this.hasParent() && this.getParent().hasParent();
  };

  BaseNode.prototype.hasSiblings = function () {
    return this.hasParent() && this.getParent().getChildren().without([this]).isNotEmpty();
  };

  BaseNode.prototype.hasPrevious = function () {
    return this.getNeighborsAndSelf().hasItem(this.getIndex() - 1);
  };

  BaseNode.prototype.hasNext = function () {
    return this.getNeighborsAndSelf().hasItem(this.getIndex() + 1);
  };

  BaseNode.prototype.getNext = function () {
    return this.getNeighborsAndSelf().item(this.getIndex() + 1);
  };
  ...
  BaseNode.prototype.getIndex = function () {
    var _this = this;
    ...
    if (this.hasParent()) {
      this.getNeighborsAndSelf().findIndex(function (node) {
        return node === _this;
      });
    }
  ...
  BaseNode.prototype._getObjectExcludeKeys = function () {
  ...
  BaseNode.prototype.toObject = function () {
    var _this = this;

    var object = {};
    Object.keys(this).filter(function (key) {
      return _this._getObjectExcludeKeys().includes(key) === false;
    }).filter(function (key) {
      return key.startsWith('remove') === false;
    }).filter(function (key) {
      return key.startsWith('add') === false;
    }).filter(function (key) {
      return typeof _this[key] === 'function';
    }).forEach(function (key) {
      try {
        object[key] = _this[key]();
      } catch (e) {}
    });
    return object;
  };
...
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_12__["__extends"])(Node, _super);
...
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_12__["__extends"])(RootNode, _super);

  function RootNode() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.nodeClass = Node;
    _this.collectionClass = NodeArray;
    return _this;
  }

  RootNode.prototype.createNode = function () {
    var node = new this.nodeClass(this);
...
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_12__["__extends"])(ValuedNode, _super);

  function ValuedNode(value) {
    var _this = _super.call(this) || this;
  ...
  ValuedNode.prototype.setValue = function (value) {
    this.value = value;
    return this;
  };

  ValuedNode.prototype.getValue = function () {
    return this.value;
  };
